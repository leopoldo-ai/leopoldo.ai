---
name: system-claw
description: System setup, diagnostics, and environment scanning agent. Detects MCP servers, verifies hooks, scans installed capabilities, runs health checks, and guides first-time setup. Use when setting up Leopoldo, troubleshooting issues, or checking system health.
model: sonnet
maxTurns: 30
tools:
  - Bash
