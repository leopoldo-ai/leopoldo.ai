...
description: Use during build loops to ensure correct workflow sequencing, on skill.invoke events, or when verifying that prerequisite skills executed before dependent ones. Maintains a skill dependency graph and checks execution order at runtime. Can be invoked directly or auto-triggered via event-dispatcher.
type: discipline
---
