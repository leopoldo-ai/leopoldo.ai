...
name: clients
version: 1.0.0
description: Use when the user invokes /clients or asks to list, manage, communicate with, or monitor Leopoldo clients from Claude Code. Client CRM access layer.
type: technique
---
