...
version: 0.2.0
description: "Design Foundations — brand identity, color theory, typography, spatial design, visual hierarchy, design quality gate, and document templates. Single source of truth for brand consistency and design quality across all output skills."
...
dependencies:
  packs: ["essentials"]
tags: ["brand", "identity", "templates", "color", "typography", "design", "spacing", "hierarchy", "audit"]
---
...
| Skill | Scopo | Priorita' |
|-------|-------|-----------|
| `spacing-mastery` | Sistema spacing 8pt, principio proximity, aggiustamenti ottici, selezione scala per contesto | P0 |
| `visual-hierarchy` | 4 livelli gerarchia, tipografia fluida, 5 layout primitives, bilanciamento peso visivo | P0 |
| `design-audit` | Quality gate post-generazione: 18 check su spacing, gerarchia, coerenza. Scoring /100 | P0 |
