...
Risk severity uses L/M/H (Low/Medium/High). Mitigation recommendations use 3 tiers. See `docs/guides/leopoldo-taxonomy.md`.

### Tier 1 — Must-have (address H risks)
- Mitigations for risks with composite score >= 15 or classified H. Execute in current cycle with named owner.

### Tier 2 — Should-have (address M risks)
- Mitigations for M-rated risks. Plan within 90 days. Re-score after mitigation.

### Tier 3 — Nice-to-have (monitor L risks)
- L-rated risks. Monitor. Controls only if the cost of prevention is trivial.
