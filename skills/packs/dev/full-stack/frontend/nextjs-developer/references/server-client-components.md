...
> Consolidated from nextjs-server-client-components skill (source: wsimmonds/claude-nextjs-skills)

## Overview

Comprehensive guidance for choosing between Server Components and Client Components in Next.js App Router, including cookie/header access, searchParams handling, pathname routing, and React's 'use' API for promise unwrapping.
...
### CRITICAL: Server Components NEVER Need 'use client'
...
**CRITICAL WARNING - Next.js 15+ searchParams:**
...
### CRITICAL: useSearchParams ALWAYS Requires Suspense
