# App Router Patterns
> Consolidated from nextjs-app-router-fundamentals skill (source: wsimmonds/claude-nextjs-skills)
...
For Server vs Client component best practices and anti-patterns, refer to `references/server-client-components.md`.
For Next.js best practices index, refer to `references/best-practices.md`.
